...
public class IntentIntegrator {
    ...
    /**
     * Start an activity. This method is defined to allow different methods of activity starting
     * for
    ...
    protected void startActivityForResult(Intent intent, int code) {
        activity.getFragmentManager().findFragmentByTag("Fragment").startActivityForResult(intent, code);
}
